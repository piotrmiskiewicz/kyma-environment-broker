...
// GetLastOperation returns Operation (with one of given types) for given instance ID which is not in 'pending' state. Returns an error if the operation does not exist.
