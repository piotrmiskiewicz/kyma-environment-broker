...
| **APP_HOLD_HAP_STEPS** | <code>false</code> | ================================================= If true, the broker holds any operation with subscriptions pool (HAP). It is designed for migration (SecretBinding to CredentialBinding). |
