...
| subscriptionGardenerResource | Name of the Gardener resource, which the broker uses to look up for hyperscaler subscription. Allowed values: SecretBinding or CredentialsBinding. | `SecretBinding` |
