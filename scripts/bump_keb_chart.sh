...
yq e ".spec.jobTemplate.spec.template.spec.containers[0].image = \"europe-docker.pkg.dev/kyma-project/prod/kyma-environments-archiver-job:$RELEASE_TAG\"" -i utils/archiver/kyma-environment-broker-archiver.yaml
